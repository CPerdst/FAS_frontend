...
import { FETCH_ALL_PERMISSIONS_URL, ADD_PERMISSION_URL, UPDATE_PERMISSION_URL, DELETE_PERMISSION_URL } from '../../../utils/constant'
...
const columnOptions = ref([
  ...
  { label: '名称', value: 'permissionName', show: true },
  { label: '描述', value: 'permissionDesc', show: true },
  { label: '创建时间', value: 'createTime', show: true },
  { label: '更新时间', value: 'updateTime', show: false },
  { label: '可删除', value: 'deletable', show: false }
])
...
const handleColumnChange = (val) => {
  // 这里不需要调用fetchPermissions，因为只是改变了显示列，不需要重新获取数据
}
...
<template>
  <div class="management-permissions">
    <el-card>
      <div class="header">
